...
const serviceDetails = {
    realisation: {
        ...
        image: realisationImg,
        description:
            "En tant que réalisateur, je prends en charge l'ensemble du processus créatif de votre projet vidéo. De la conception du scénario à la direction d'équipe sur le terrain, je m'assure que chaque plan raconte votre histoire de la manière la plus impactante possible.",
        features: [
        ...
        process: [
            {
                step: "Brief & Concept",
                description: "Analyse de vos besoins et développement créatif",
            },
            {
                step: "Pré-production",
                description: "Scénario, storyboard, repérages, casting",
            },
            {
                step: "Tournage",
                description:
                    "Réalisation sur le terrain avec l'équipe technique",
            },
            {
                step: "Livraison",
                description:
                    "Supervision de la post-production jusqu'à la livraison",
            },
        ],
        pricing: "Sur devis - À partir de 2 500€",
        duration: "Variable selon le projet",
        style: "translate-x--16",
    },
    montage: {
        title: "Montage Vidéo",
        ...
        description:
            "Le montage est l'art de raconter une histoire à travers l'assemblage des images. Avec une maîtrise technique pointue et une sensibilité narrative, je donne du rythme et de l'émotion à vos contenus vidéo.",
        features: [
        ...
        process: [
            {
                step: "Dérushage",
                description: "Analyse et sélection des meilleurs plans",
            },
            {
                step: "Montage",
                description: "Première version de la structure narrative",
            },
            {
                step: "Colorimétrie",
                description: "Affinage, ajustements et peaufinage",
            },
            {
                step: "Validation",
                description: "Aller-retours et modifications selon vos retours",
            },
        ],
    ...
    conception: {
        ...
        description:
            "Chaque projet mérite une approche unique. Je développe des concepts créatifs sur-mesure qui reflètent votre identité et captent l'attention de votre audience cible.",
        features: [
        ...
        process: [
            {
                step: "Immersion",
                description: "Découverte de votre univers et objectifs",
            },
            {
                step: "Recherche",
                description: "Veille créative et identification des tendances",
            },
            {
                step: "Idéation",
                description: "Génération de concepts multiples",
            },
            {
                step: "Présentation",
                description: "Pitch des meilleures idées avec supports visuels",
            },
        ],
    ...
    "post-production": {
        ...
        description:
            "La post-production est l'étape finale qui transforme vos rushes en œuvre aboutie. Étalonnage colorimétrique, design sonore et effets visuels : chaque détail compte pour un rendu cinématographique.",
        features: [
        ...
        process: [
            {
                step: "Analyse",
                description: "Évaluation des besoins techniques",
            },
            {
                step: "Color grading",
                description: "Création d'une palette cohérente",
            },
            {
                step: "Audio",
                description: "Mixage, equalisation, effets sonores",
            },
            {
                step: "Finalisation",
                description: "Export master et déclinaisons",
            },
        ],
    ...
    entreprise: {
        ...
        description:
            "La vidéo corporate est un outil puissant pour valoriser votre entreprise, former vos équipes ou présenter vos produits. Je crée des contenus professionnels adaptés à vos enjeux business.",
        features: [
        ...
        process: [
            {
                step: "Cadrage",
                description: "Définition des objectifs et messages clés",
            },
            {
                step: "Production",
                description: "Tournage dans vos locaux ou en studio",
            },
            {
                step: "Montage",
                description: "Habillage aux couleurs de votre charte",
            },
            {
                step: "Diffusion",
                description: "Formats optimisés pour tous supports",
            },
        ],
    ...
    "motion-design": {
        ...
        description:
            "Le motion design allie créativité graphique et animation pour créer des visuels dynamiques et mémorables. Parfait pour vulgariser des concepts complexes ou créer un habillage unique.",
        features: [
                    ...
                    <div className="bg-zinc-950 p-8 rounded-lg border border-white/10">
                        <div>
                            ...
                            <div className="text-xl text-pretty">
                                ...
                                n’hésitez pas à me contacter. Je serai ravi
                                d’échanger avec vous et de vous proposer un
                                devis personnalisé.
                            </div>
                        </div>
                        <div className="mt-8">
