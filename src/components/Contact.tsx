  ...
  return (
    <section id="contact" className="py-24 bg-black relative z-10">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div>marc.dubois@exemple.fr</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="text-gray-400 text-sm mb-2">Réseaux sociaux</div>
            ...
            <div className="mt-8 p-6 bg-white/5 rounded-lg border border-white/10">
              <p className="text-gray-300">
                Je suis disponible pour des projets en freelance et ouvert à toute collaboration créative. 
            ...
            <form action={"mailto:bastienbillard69100@gmail.com"} method="GET" className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="corporate">Vidéo d'entreprise</option>
      ...
      <div className="mt-24 pt-8 border-t border-white/10 text-center text-gray-500 text-sm">
        <p>© 2025 Marc Dubois - Réalisateur & Monteur Vidéo. Tous droits réservés.</p>
      </div>
    </section>
  );
}